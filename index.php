...
?>
	...
	<div class="container-fluid feed" id="pic-feed">
		...
		<div class="col-sm-3 offset-sm-1 pic-div">
			<a href = "<?php echo $src ?>">
				<img class=" img-responsive" 
					 src="../wordpress/wp-content/themes/missingPersons/images/icon.png">
        ...
        <br>
        <button class="btn btn-default btn-viewall"><a href ="http://wordpress.local/wordpress/3-browse-cases-with-pictures">VIEW ALL</a></button>
	</div>
    ...
    <div class="container-fluid feed" id="unsolved-div">
		...
		<button class="btn btn-default btn-viewall">
			<a href ="http://wordpress.local/wordpress/2-browse-cases-full?type={unsolved}">VIEW ALL</a>
        </button>
	</div> 
        ...
        <div class="container-fluid feed" id="solved-div">
		  ...
		  ?>
            ...
            ?>
			<button class="btn btn-default btn-viewall">
				<a href ="http://wordpress.local/wordpress/2-browse-cases-full?type={solved}">VIEW ALL</a>
            </button>
		</div> <br><br>
